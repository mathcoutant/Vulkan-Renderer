...
private:
    ...
    void createInstance() {
        ...
        auto requiredExtensionsCount = static_cast<uint32_t>(requiredExtensions.size());
        checkExtensionsAvailable(requiredExtensions, extensions);
    ...
    VkPresentModeKHR chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) const {
        ...
        // This mode is assured to be present and
        // is also the less demanding on enregy (good for mobile)
    ...
    void checkExtensionsAvailable(std::vector<const char*> const& requiredExtensions, std::vector<VkExtensionProperties> const& extensions) const {
        std::cout << "Checking if required extensions are available...\n";
        for (const auto& requiredExtension : requiredExtensions) {
            ...
            if (!isThere) {
                std::cout << "\t The extension " << requiredExtension << " cannot be found!" << '\n';
            }
        }
    }
    ...
    void populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) const {
        ...
        createInfo.messageSeverity = VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT | VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT; // add VK_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT to be verbose
